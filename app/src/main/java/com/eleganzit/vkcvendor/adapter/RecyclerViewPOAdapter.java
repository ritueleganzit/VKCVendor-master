...
public class RecyclerViewPOAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public RecyclerViewPOAdapter(Context context, ArrayList<String> data) {
